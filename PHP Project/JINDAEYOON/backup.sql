...
CREATE TABLE IF NOT EXISTS `DateMaking` (
  ...
  PRIMARY KEY  (`No`)
) ENGINE=MyISAM  DEFAULT CHARSET=euckr AUTO_INCREMENT=113 ;

--
-- 테이블의 덤프 데이터 `DateMaking`
--

INSERT INTO `DateMaking` (`No`, `GroupTitle`, `timeFixTitle`, `timeFixOutline`, `eventTime`, `choice`, `send`) VALUES
(112, '?¹??Œ???°', '', '', '', 0, 0);

-- --------------------------------------------------------

--
-- 테이블 구조 `DateMaking_contactsList`
--

CREATE TABLE IF NOT EXISTS `DateMaking_contactsList` (
  `No` int(11) NOT NULL,
  ...
  PRIMARY KEY  (`pk`)
) ENGINE=MyISAM  DEFAULT CHARSET=euckr AUTO_INCREMENT=64 ;

--
-- 테이블의 덤프 데이터 `DateMaking_contactsList`
--

INSERT INTO `DateMaking_contactsList` (`No`, `pk`, `name`, `email`, `phonenum`) VALUES
(112, 63, '?¹? ?Œ???°', '(null)', '010-4844-7086');

-- --------------------------------------------------------

--
-- 테이블 구조 `DateMaking_dateList`
--

CREATE TABLE IF NOT EXISTS `DateMaking_dateList` (
  `No` int(11) NOT NULL,
  `pk` int(11) NOT NULL auto_increment,
...
--
-- 테이블의 덤프 데이터 `DateMaking_dateList`
--
...
--
-- 테이블 구조 `DateMaking_response`
--

CREATE TABLE IF NOT EXISTS `DateMaking_response` (
  `No` int(11) NOT NULL,
  `Name` varchar(100) character set euckr collate euckr_bin NOT NULL,
  `phonenum` varchar(20) character set euckr collate euckr_bin NOT NULL,
...
--
-- 테이블의 덤프 데이터 `DateMaking_response`
--

INSERT INTO `DateMaking_response` (`No`, `Name`, `phonenum`, `PK`, `resp`, `time`) VALUES
(112, '', '010-4844-7086', 5, 1, '');

-- --------------------------------------------------------

--
-- 테이블 구조 `DateMaking_timeList`
--

CREATE TABLE IF NOT EXISTS `DateMaking_timeList` (
  `No` int(11) NOT NULL,
  `pk` int(11) NOT NULL auto_increment,
  `time` varchar(30) NOT NULL,
  PRIMARY KEY  (`pk`)
) ENGINE=MyISAM  DEFAULT CHARSET=euckr AUTO_INCREMENT=13 ;

--
-- 테이블의 덤프 데이터 `DateMaking_timeList`
--
...
CREATE TABLE IF NOT EXISTS `TimeMaking` (
  `No` int(11) NOT NULL auto_increment,
  `GroupTitle` varchar(100) NOT NULL,
  ...
  PRIMARY KEY  (`No`)
) ENGINE=MyISAM  DEFAULT CHARSET=euckr AUTO_INCREMENT=19 ;

--
-- 테이블의 덤프 데이터 `TimeMaking`
--

INSERT INTO `TimeMaking` (`No`, `GroupTitle`, `meetingTitle`, `meetingOutline`, `attandance`, `alarm`, `location`) VALUES
(18, '?¹??Œ???°', '?¹??Œ???°?…‡?…‡?…‡?…‡', '', '', 0, '');

-- --------------------------------------------------------

--
-- 테이블 구조 `TimeMaking_contactsList`
--

CREATE TABLE IF NOT EXISTS `TimeMaking_contactsList` (
  `No` int(11) NOT NULL,
  `pk` int(11) NOT NULL auto_increment,
  `name` varchar(30) NOT NULL,
  `email` varchar(30) NOT NULL,
  `phoneNum` varchar(30) NOT NULL,
  PRIMARY KEY  (`pk`)
) ENGINE=MyISAM  DEFAULT CHARSET=euckr AUTO_INCREMENT=78 ;

--
-- 테이블의 덤프 데이터 `TimeMaking_contactsList`
--

INSERT INTO `TimeMaking_contactsList` (`No`, `pk`, `name`, `email`, `phoneNum`) VALUES
(18, 77, '?¹? ?Œ???°', '(null)', '010-4844-7086');

-- --------------------------------------------------------

--
-- 테이블 구조 `TimeMaking_context`
--

CREATE TABLE IF NOT EXISTS `TimeMaking_context` (
  `key` int(11) NOT NULL,
  `title` varchar(100) NOT NULL,
  `phonenum` varchar(20) NOT NULL,
  `context` varchar(280) character set euckr collate euckr_bin NOT NULL,
  `time` varchar(30) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=euckr;

--
-- 테이블의 덤프 데이터 `TimeMaking_context`
--
...
--
-- 테이블 구조 `TimeMaking_dateList`
--

CREATE TABLE IF NOT EXISTS `TimeMaking_dateList` (
  `No` int(11) NOT NULL,
  `pk` int(11) NOT NULL auto_increment,
...
--
-- 테이블의 덤프 데이터 `TimeMaking_dateList`
--

INSERT INTO `TimeMaking_dateList` (`No`, `pk`, `date`) VALUES
(18, 12, '2012/8/(null)');

-- --------------------------------------------------------

--
-- 테이블 구조 `TimeMaking_timeList`
--

CREATE TABLE IF NOT EXISTS `TimeMaking_timeList` (
  `No` int(11) NOT NULL,
  `pk` int(11) NOT NULL auto_increment,
...
--
-- 테이블의 덤프 데이터 `TimeMaking_timeList`
--

INSERT INTO `TimeMaking_timeList` (`No`, `pk`, `time`) VALUES
(18, 12, '22/1');
...
CREATE TABLE IF NOT EXISTS `group_user` (
  ...
  `Gcheck` varchar(30) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=euckr;

--
-- 테이블의 덤프 데이터 `group_user`
--
...
INSERT INTO `user` (`No`, `Name`, `PhoneNumber`, `DeviceID`) VALUES
(5, '', '01048447086', '673D56DB-D542-4EC9-AC9C-4FE5BA28F1DF');
--
-- 데이터베이스: `SMS`
--
CREATE DATABASE `SMS` DEFAULT CHARACTER SET euckr COLLATE euckr_bin;
USE `SMS`;

-- --------------------------------------------------------

--
-- 테이블 구조 `em_log_201208`
--

CREATE TABLE IF NOT EXISTS `em_log_201208` (
  `tran_pr` int(11) NOT NULL,
  `tran_refkey` varchar(40) collate euckr_bin default NULL,
  `tran_id` varchar(20) collate euckr_bin default NULL,
  `tran_phone` varchar(15) collate euckr_bin NOT NULL,
  `tran_callback` varchar(15) collate euckr_bin default NULL,
  `tran_status` char(1) collate euckr_bin default NULL,
  `tran_date` datetime NOT NULL,
  `tran_rsltdate` datetime default NULL,
  `tran_reportdate` datetime default NULL,
  `tran_rslt` char(1) collate euckr_bin default NULL,
  `tran_net` varchar(3) collate euckr_bin default NULL,
  `tran_msg` varchar(255) collate euckr_bin default NULL,
  `tran_etc1` varchar(64) collate euckr_bin default NULL,
  `tran_etc2` varchar(16) collate euckr_bin default NULL,
  `tran_etc3` varchar(16) collate euckr_bin default NULL,
  `tran_etc4` int(11) default NULL,
  `tran_type` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=euckr COLLATE=euckr_bin;

--
-- 테이블의 덤프 데이터 `em_log_201208`
--

INSERT INTO `em_log_201208` (`tran_pr`, `tran_refkey`, `tran_id`, `tran_phone`, `tran_callback`, `tran_status`, `tran_date`, `tran_rsltdate`, `tran_reportdate`, `tran_rslt`, `tran_net`, `tran_msg`, `tran_etc1`, `tran_etc2`, `tran_etc3`, `tran_etc4`, `tran_type`) VALUES
(1, NULL, NULL, '010-7442-3141', '010-000-0000', '3', '2012-08-09 11:22:52', '2012-08-09 11:23:03', '2012-08-09 11:23:07', '0', 'KTF', 'Test Message입니다', NULL, NULL, NULL, NULL, 4),
(2, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 11:44:44', '2012-08-09 11:44:46', '2012-08-09 11:44:46', 'z', NULL, '', NULL, NULL, NULL, NULL, 4),
(3, NULL, NULL, '01074423141', '010-000-0000', '3', '2012-08-09 11:45:54', '2012-08-09 11:46:00', '2012-08-09 11:46:03', '0', 'KTF', 'Test Message입니다', NULL, NULL, NULL, NULL, 4),
(4, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 11:46:26', '2012-08-09 11:46:27', '2012-08-09 11:46:27', 'z', NULL, '', NULL, NULL, NULL, NULL, 4),
(5, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 11:46:44', '2012-08-09 11:46:44', '2012-08-09 11:46:44', 'z', NULL, '', NULL, NULL, NULL, NULL, 4),
(6, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 11:47:13', '2012-08-09 11:47:15', '2012-08-09 11:47:15', 'z', NULL, '', NULL, NULL, NULL, NULL, 4),
(7, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 11:47:28', '2012-08-09 11:47:29', '2012-08-09 11:47:29', 'z', NULL, '', NULL, NULL, NULL, NULL, 4),
(8, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 11:47:43', '2012-08-09 11:47:50', '2012-08-09 11:47:55', '0', 'SKT', 'asdfasdf', NULL, NULL, NULL, NULL, 4),
(9, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 16:17:50', NULL, NULL, '1', 'etc', '?¹??Œ???° ?°”?³´', NULL, NULL, NULL, NULL, 4),
(10, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 16:24:34', NULL, NULL, '1', 'etc', '?¹??Œ???° ?°”?³´', NULL, NULL, NULL, NULL, 4),
(11, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 16:24:41', NULL, NULL, '1', 'etc', '?¹??Œ???° ?°”?³´', NULL, NULL, NULL, NULL, 4),
(12, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 16:24:43', NULL, NULL, '1', 'etc', '?¹??Œ???° ?°”?³´', NULL, NULL, NULL, NULL, 4),
(13, NULL, NULL, '01048447086', '010-000-0000', '3', '2012-08-09 16:29:06', NULL, NULL, '1', 'etc', '?…†?…†', NULL, NULL, NULL, NULL, 4),
(14, NULL, NULL, 'Array[0]', '052-217-7302', '3', '2012-08-12 11:59:25', '2012-08-12 11:59:26', '2012-08-12 11:59:26', 'p', NULL, 'Array[0]', NULL, NULL, NULL, NULL, 4),
(15, NULL, NULL, 'Array[0]', '052-217-7302', '3', '2012-08-12 12:00:09', '2012-08-12 12:00:10', '2012-08-12 12:00:10', 'p', NULL, 'Array[0]', NULL, NULL, NULL, NULL, 4),
(16, NULL, NULL, '010-7442-3141', '052-217-7302', '3', '2012-08-12 12:01:56', '2012-08-12 12:02:03', '2012-08-12 12:02:06', '0', 'KTF', 'http://125.209.196.29/DateMaking_process.php?phonenum=010-7442-3141&key=55', NULL, NULL, NULL, NULL, 4),
(17, NULL, NULL, '010-7442-3141', '052-217-7302', '3', '2012-08-13 11:15:30', '2012-08-13 11:15:39', '2012-08-13 11:15:41', '0', 'KTF', 'http://125.209.196.29/DateMaking_process.php?phonenum=010-7442-3141&key=55', NULL, NULL, NULL, NULL, 4),
(18, NULL, NULL, '01048447086', '052-217-7302', '3', '2012-08-13 11:26:35', '2012-08-13 11:26:43', '2012-08-13 11:26:47', '0', 'SKT', 'http://125.209.196.29/DateMaking_process.php?phonenum=01048447086&key=111', NULL, NULL, NULL, NULL, 4),
(19, NULL, NULL, '', '052-217-7302', '3', '2012-08-15 22:46:25', '2012-08-15 22:46:25', '2012-08-15 22:46:25', 'p', NULL, 'http://125.209.196.29/TimeMaking_process.php?phonenum=&key=17', NULL, NULL, NULL, NULL, 4),
(20, NULL, NULL, '010-4844-7086', '052-217-7302', '3', '2012-08-15 22:47:55', '2012-08-15 22:48:02', '2012-08-15 22:48:07', '0', 'SKT', 'http://125.209.196.29/TimeMaking_process.php?phonenum=010-4844-7086&key=17', NULL, NULL, NULL, NULL, 4),
(21, NULL, NULL, '010-4844-7086', '052-217-7302', '3', '2012-08-15 22:52:02', '2012-08-15 22:52:12', '2012-08-15 22:52:15', '0', 'SKT', 'http://125.209.196.29/TimeMaking_process.php?phonenum=010-4844-7086&key=18', NULL, NULL, NULL, NULL, 4),
(22, NULL, NULL, '010-4844-7086', '052-217-7302', '3', '2012-08-15 23:01:29', '2012-08-15 23:01:38', '2012-08-15 23:01:42', '0', 'SKT', 'http://125.209.196.29/DateMaking_process.php?phonenum=010-4844-7086&key=112', NULL, NULL, NULL, NULL, 4);
...
CREATE TABLE IF NOT EXISTS `em_tran` (
  ...
  `tran_type` int(11) NOT NULL,
  PRIMARY KEY  (`tran_pr`),
  KEY `idx_em_tran_01` (`tran_status`,`tran_date`)
) ENGINE=MyISAM  DEFAULT CHARSET=euckr COLLATE=euckr_bin AUTO_INCREMENT=23 ;
...
CREATE TABLE IF NOT EXISTS `em_tran_mms` (
  `mms_seq` int(11) NOT NULL auto_increment,
  `file_cnt` int(11) NOT NULL,
  `build_yn` char(1) collate euckr_bin default NULL,
  `mms_body` text collate euckr_bin,
  `mms_subject` varchar(40) collate euckr_bin default NULL,
  `file_type1` varchar(3) collate euckr_bin default NULL,
  `file_type2` varchar(3) collate euckr_bin default NULL,
  `file_type3` varchar(3) collate euckr_bin default NULL,
  `file_type4` varchar(3) collate euckr_bin default NULL,
  `file_type5` varchar(3) collate euckr_bin default NULL,
  `file_name1` varchar(100) collate euckr_bin default NULL,
  `file_name2` varchar(100) collate euckr_bin default NULL,
  `file_name3` varchar(100) collate euckr_bin default NULL,
  `file_name4` varchar(100) collate euckr_bin default NULL,
  `file_name5` varchar(100) collate euckr_bin default NULL,
  `service_dep1` varchar(3) collate euckr_bin default NULL,
  `service_dep2` varchar(3) collate euckr_bin default NULL,
  `service_dep3` varchar(3) collate euckr_bin default NULL,
  `service_dep4` varchar(3) collate euckr_bin default NULL,
  `service_dep5` varchar(3) collate euckr_bin default NULL,
  `skn_file_name` varchar(255) collate euckr_bin default NULL,
  PRIMARY KEY  (`mms_seq`)
) ENGINE=MyISAM DEFAULT CHARSET=euckr COLLATE=euckr_bin AUTO_INCREMENT=1 ;

--
-- 테이블의 덤프 데이터 `em_tran_mms`
--
...
(NULL, 'DB', 'DateMaking', 'No', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking', 'GroupTitle', 2, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking', 'timeFixTitle', 3, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking', 'timeFixOutline', 4, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking', 'eventTime', 5, NULL, 'NO', 'varchar', 10, 20, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking', 'choice', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking', 'send', 7, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_contactsList', 'No', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_contactsList', 'pk', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_contactsList', 'name', 3, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_contactsList', 'email', 4, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_contactsList', 'phonenum', 5, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_dateList', 'No', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_dateList', 'pk', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_dateList', 'date', 3, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_response', 'No', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_response', 'Name', 2, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_response', 'phonenum', 3, NULL, 'NO', 'varchar', 20, 40, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_response', 'PK', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_response', 'resp', 5, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_response', 'time', 6, NULL, 'NO', 'varchar', 20, 40, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_timeList', 'No', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_timeList', 'pk', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'DB', 'DateMaking_timeList', 'time', 3, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'GR', 'Name', 1, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'Group', 'Name', 1, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking', 'No', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking', 'GroupTitle', 2, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking', 'meetingTitle', 3, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking', 'meetingOutline', 4, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking', 'attandance', 5, NULL, 'NO', 'varchar', 10, 20, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking', 'alarm', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking', 'location', 7, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_contactsList', 'No', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_contactsList', 'pk', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_contactsList', 'name', 3, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_contactsList', 'email', 4, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_contactsList', 'phoneNum', 5, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_context', 'key', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_context', 'title', 2, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_context', 'phonenum', 3, NULL, 'NO', 'varchar', 20, 40, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_context', 'context', 4, NULL, 'NO', 'varchar', 280, 560, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(280)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_context', 'time', 5, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_dateList', 'No', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_dateList', 'pk', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_dateList', 'date', 3, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_timeList', 'No', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_timeList', 'pk', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'DB', 'TimeMaking_timeList', 'time', 3, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'group_user', 'PhoneNumber', 1, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'group_user', 'Gcheck', 2, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'user', 'No', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'DB', 'user', 'Name', 2, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'user', 'PhoneNumber', 3, NULL, 'NO', 'varchar', 30, 60, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'DB', 'user', 'DeviceID', 4, NULL, 'NO', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_korean_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_pr', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_refkey', 2, NULL, 'YES', 'varchar', 40, 80, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(40)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_id', 3, NULL, 'YES', 'varchar', 20, 40, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_phone', 4, NULL, 'NO', 'varchar', 15, 30, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_callback', 5, NULL, 'YES', 'varchar', 15, 30, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_status', 6, NULL, 'YES', 'char', 1, 2, NULL, NULL, 'euckr', 'euckr_bin', 'char(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_date', 7, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_rsltdate', 8, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_reportdate', 9, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_rslt', 10, NULL, 'YES', 'char', 1, 2, NULL, NULL, 'euckr', 'euckr_bin', 'char(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_net', 11, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_msg', 12, NULL, 'YES', 'varchar', 255, 510, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_etc1', 13, NULL, 'YES', 'varchar', 64, 128, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(64)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_etc2', 14, NULL, 'YES', 'varchar', 16, 32, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(16)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_etc3', 15, NULL, 'YES', 'varchar', 16, 32, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(16)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_etc4', 16, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_log_201208', 'tran_type', 17, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_pr', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_refkey', 2, NULL, 'YES', 'varchar', 40, 80, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(40)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_id', 3, NULL, 'YES', 'varchar', 20, 40, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_phone', 4, NULL, 'NO', 'varchar', 15, 30, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_callback', 5, NULL, 'YES', 'varchar', 15, 30, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_status', 6, NULL, 'YES', 'char', 1, 2, NULL, NULL, 'euckr', 'euckr_bin', 'char(1)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_date', 7, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_rsltdate', 8, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_reportdate', 9, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_rslt', 10, NULL, 'YES', 'char', 1, 2, NULL, NULL, 'euckr', 'euckr_bin', 'char(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_net', 11, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_msg', 12, NULL, 'YES', 'varchar', 255, 510, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_etc1', 13, NULL, 'YES', 'varchar', 64, 128, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(64)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_etc2', 14, NULL, 'YES', 'varchar', 16, 32, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(16)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_etc3', 15, NULL, 'YES', 'varchar', 16, 32, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(16)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_etc4', 16, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran', 'tran_type', 17, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'mms_seq', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_cnt', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'build_yn', 3, NULL, 'YES', 'char', 1, 2, NULL, NULL, 'euckr', 'euckr_bin', 'char(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'mms_body', 4, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'euckr', 'euckr_bin', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'mms_subject', 5, NULL, 'YES', 'varchar', 40, 80, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(40)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_type1', 6, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_type2', 7, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_type3', 8, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_type4', 9, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_type5', 10, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_name1', 11, NULL, 'YES', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_name2', 12, NULL, 'YES', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_name3', 13, NULL, 'YES', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_name4', 14, NULL, 'YES', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'file_name5', 15, NULL, 'YES', 'varchar', 100, 200, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'service_dep1', 16, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'service_dep2', 17, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'service_dep3', 18, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'service_dep4', 19, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'service_dep5', 20, NULL, 'YES', 'varchar', 3, 6, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(3)', '', '', 'select,insert,update,references', ''),
(NULL, 'SMS', 'em_tran_mms', 'skn_file_name', 21, NULL, 'YES', 'varchar', 255, 510, NULL, NULL, 'euckr', 'euckr_bin', 'varchar(255)', '', '', 'select,insert,update,references', ''),
...
(NULL, 'DB', 'PRIMARY', NULL, 'DB', 'DateMaking', 'No', 1, NULL, NULL, NULL, NULL),
(NULL, 'DB', 'PRIMARY', NULL, 'DB', 'DateMaking_contactsList', 'pk', 1, NULL, NULL, NULL, NULL),
(NULL, 'DB', 'PRIMARY', NULL, 'DB', 'DateMaking_dateList', 'pk', 1, NULL, NULL, NULL, NULL),
(NULL, 'DB', 'PRIMARY', NULL, 'DB', 'DateMaking_response', 'PK', 1, NULL, NULL, NULL, NULL),
(NULL, 'DB', 'PRIMARY', NULL, 'DB', 'DateMaking_timeList', 'pk', 1, NULL, NULL, NULL, NULL),
(NULL, 'DB', 'PRIMARY', NULL, 'DB', 'TimeMaking', 'No', 1, NULL, NULL, NULL, NULL),
(NULL, 'DB', 'PRIMARY', NULL, 'DB', 'TimeMaking_contactsList', 'pk', 1, NULL, NULL, NULL, NULL),
(NULL, 'DB', 'PRIMARY', NULL, 'DB', 'TimeMaking_dateList', 'pk', 1, NULL, NULL, NULL, NULL),
(NULL, 'DB', 'PRIMARY', NULL, 'DB', 'TimeMaking_timeList', 'pk', 1, NULL, NULL, NULL, NULL),
(NULL, 'DB', 'PRIMARY', NULL, 'DB', 'user', 'No', 1, NULL, NULL, NULL, NULL),
(NULL, 'SMS', 'PRIMARY', NULL, 'SMS', 'em_tran', 'tran_pr', 1, NULL, NULL, NULL, NULL),
(NULL, 'SMS', 'PRIMARY', NULL, 'SMS', 'em_tran_mms', 'mms_seq', 1, NULL, NULL, NULL, NULL),
...
-- 사용중 (#1289 - The 'SHOW PROFILE' feature is disabled; you need MySQL built with 'enable-profiling' to have it working)
...
(NULL, 'DB', 'euckr', 'euckr_korean_ci', NULL),
(NULL, 'SMS', 'euckr', 'euckr_bin', NULL),
...
(NULL, 'DB', 'DateMaking', 0, 'DB', 'PRIMARY', 1, 'No', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'DB', 'DateMaking_contactsList', 0, 'DB', 'PRIMARY', 1, 'pk', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'DB', 'DateMaking_dateList', 0, 'DB', 'PRIMARY', 1, 'pk', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'DB', 'DateMaking_response', 0, 'DB', 'PRIMARY', 1, 'PK', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'DB', 'DateMaking_timeList', 0, 'DB', 'PRIMARY', 1, 'pk', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'DB', 'TimeMaking', 0, 'DB', 'PRIMARY', 1, 'No', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'DB', 'TimeMaking_contactsList', 0, 'DB', 'PRIMARY', 1, 'pk', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'DB', 'TimeMaking_dateList', 0, 'DB', 'PRIMARY', 1, 'pk', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'DB', 'TimeMaking_timeList', 0, 'DB', 'PRIMARY', 1, 'pk', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'DB', 'user', 0, 'DB', 'PRIMARY', 1, 'No', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'SMS', 'em_tran', 0, 'SMS', 'PRIMARY', 1, 'tran_pr', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'SMS', 'em_tran', 1, 'SMS', 'idx_em_tran_01', 1, 'tran_status', 'A', NULL, NULL, NULL, 'YES', 'BTREE', ''),
(NULL, 'SMS', 'em_tran', 1, 'SMS', 'idx_em_tran_01', 2, 'tran_date', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'SMS', 'em_tran_mms', 0, 'SMS', 'PRIMARY', 1, 'mms_seq', 'A', 0, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-08-16 18:52:17', '2012-08-16 18:52:17', NULL, 'utf8_general_ci', NULL, 'max_rows=8715', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-08-16 18:52:17', '2012-08-16 18:52:17', NULL, 'utf8_general_ci', NULL, 'max_rows=9172', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-08-16 18:52:17', '2012-08-16 18:52:17', NULL, 'utf8_general_ci', NULL, 'max_rows=7652', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 0, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-08-16 18:52:17', '2012-08-16 18:52:17', NULL, 'utf8_general_ci', NULL, 'max_rows=15073', ''),
(NULL, 'DB', 'DateMaking', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 40, 400, 281474976710655, 2048, 360, 113, '2012-08-11 09:20:07', '2012-08-15 23:01:16', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'DateMaking_contactsList', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 80, 960, 281474976710655, 2048, 880, 64, '2012-08-07 10:55:39', '2012-08-15 23:01:16', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'DateMaking_dateList', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 240, 281474976710655, 2048, 240, 18, '2012-08-07 10:45:36', '2012-08-12 09:34:51', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'DateMaking_response', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 32, 64, 281474976710655, 2048, 32, 6, '2012-08-14 18:06:50', '2012-08-15 23:01:58', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'DateMaking_timeList', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 80, 281474976710655, 2048, 80, 13, '2012-08-07 10:45:48', '2012-08-13 11:22:52', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'GR', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 38, 520, 281474976710655, 1024, 444, NULL, '2012-07-29 13:37:12', '2012-08-16 18:46:28', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'Group', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-07-29 13:23:26', '2012-07-29 13:23:26', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'TimeMaking', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 80, 328, 281474976710655, 2048, 248, 19, '2012-08-07 12:02:12', '2012-08-15 22:51:29', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'TimeMaking_contactsList', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 76, 828, 281474976710655, 2048, 752, 78, '2012-08-07 12:03:17', '2012-08-15 22:51:44', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'TimeMaking_context', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-08-14 21:27:50', '2012-08-14 21:27:50', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'TimeMaking_dateList', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 140, 281474976710655, 2048, 112, 13, '2012-08-07 12:03:42', '2012-08-15 22:51:52', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'TimeMaking_timeList', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 20, 120, 281474976710655, 2048, 100, 13, '2012-08-07 12:03:52', '2012-08-15 22:52:00', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'group_user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 68, 281474976710655, 1024, 68, NULL, '2012-07-29 13:42:57', '2012-08-07 10:49:42', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'DB', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 72, 72, 281474976710655, 2048, 0, 6, '2012-08-15 21:59:46', '2012-08-15 22:00:52', NULL, 'euckr_korean_ci', NULL, '', ''),
(NULL, 'SMS', 'em_log_201208', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 22, 104, 2288, 281474976710655, 1024, 0, NULL, '2012-08-09 11:14:03', '2012-08-15 23:01:42', NULL, 'euckr_bin', NULL, '', ''),
(NULL, 'SMS', 'em_tran', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 860, 281474976710655, 3072, 860, 23, '2012-08-09 11:14:03', '2012-08-15 23:01:42', '2012-08-09 11:14:03', 'euckr_bin', NULL, '', ''),
(NULL, 'SMS', 'em_tran_mms', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-08-09 11:14:03', '2012-08-09 11:14:03', NULL, 'euckr_bin', NULL, '', ''),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 1024, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 438, 876, 123286039799267327, 4096, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', '2012-07-28 23:11:49', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 36, 581, 20916, 163536961468891135, 3072, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 404, 197, 79588, 55450570411999231, 14336, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 850, 9, 7650, 2533274790395903, 16384, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 484, 767, 371472, 281474976710655, 17408, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 109775240917155839, 1024, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 1024, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 1024, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:11:49', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 52, 264, 281474976710655, 2048, 0, NULL, '2012-07-28 23:11:49', '2012-07-28 23:36:12', NULL, 'utf8_bin', NULL, '', 'Users and global privileges');
...
(NULL, 'DB', 'PRIMARY', 'DB', 'DateMaking', 'PRIMARY KEY'),
(NULL, 'DB', 'PRIMARY', 'DB', 'DateMaking_contactsList', 'PRIMARY KEY'),
(NULL, 'DB', 'PRIMARY', 'DB', 'DateMaking_dateList', 'PRIMARY KEY'),
(NULL, 'DB', 'PRIMARY', 'DB', 'DateMaking_response', 'PRIMARY KEY'),
(NULL, 'DB', 'PRIMARY', 'DB', 'DateMaking_timeList', 'PRIMARY KEY'),
(NULL, 'DB', 'PRIMARY', 'DB', 'TimeMaking', 'PRIMARY KEY'),
(NULL, 'DB', 'PRIMARY', 'DB', 'TimeMaking_contactsList', 'PRIMARY KEY'),
(NULL, 'DB', 'PRIMARY', 'DB', 'TimeMaking_dateList', 'PRIMARY KEY'),
(NULL, 'DB', 'PRIMARY', 'DB', 'TimeMaking_timeList', 'PRIMARY KEY'),
(NULL, 'DB', 'PRIMARY', 'DB', 'user', 'PRIMARY KEY'),
(NULL, 'SMS', 'PRIMARY', 'SMS', 'em_tran', 'PRIMARY KEY'),
(NULL, 'SMS', 'PRIMARY', 'SMS', 'em_tran_mms', 'PRIMARY KEY'),
...
('''root''@''Teamstudy''', NULL, 'SELECT', 'YES'),
('''root''@''Teamstudy''', NULL, 'INSERT', 'YES'),
('''root''@''Teamstudy''', NULL, 'UPDATE', 'YES'),
('''root''@''Teamstudy''', NULL, 'DELETE', 'YES'),
('''root''@''Teamstudy''', NULL, 'CREATE', 'YES'),
('''root''@''Teamstudy''', NULL, 'DROP', 'YES'),
('''root''@''Teamstudy''', NULL, 'RELOAD', 'YES'),
('''root''@''Teamstudy''', NULL, 'SHUTDOWN', 'YES'),
('''root''@''Teamstudy''', NULL, 'PROCESS', 'YES'),
('''root''@''Teamstudy''', NULL, 'FILE', 'YES'),
('''root''@''Teamstudy''', NULL, 'REFERENCES', 'YES'),
('''root''@''Teamstudy''', NULL, 'INDEX', 'YES'),
('''root''@''Teamstudy''', NULL, 'ALTER', 'YES'),
('''root''@''Teamstudy''', NULL, 'SHOW DATABASES', 'YES'),
('''root''@''Teamstudy''', NULL, 'SUPER', 'YES'),
('''root''@''Teamstudy''', NULL, 'CREATE TEMPORARY TABLES', 'YES'),
('''root''@''Teamstudy''', NULL, 'LOCK TABLES', 'YES'),
('''root''@''Teamstudy''', NULL, 'EXECUTE', 'YES'),
('''root''@''Teamstudy''', NULL, 'REPLICATION SLAVE', 'YES'),
('''root''@''Teamstudy''', NULL, 'REPLICATION CLIENT', 'YES'),
('''root''@''Teamstudy''', NULL, 'CREATE VIEW', 'YES'),
('''root''@''Teamstudy''', NULL, 'SHOW VIEW', 'YES'),
('''root''@''Teamstudy''', NULL, 'CREATE ROUTINE', 'YES'),
('''root''@''Teamstudy''', NULL, 'ALTER ROUTINE', 'YES'),
('''root''@''Teamstudy''', NULL, 'CREATE USER', 'YES'),
...
--
-- 테이블의 덤프 데이터 `time_zone_leap_second`
--
...
--
-- 테이블의 덤프 데이터 `time_zone_transition`
--
...
--
-- 테이블의 덤프 데이터 `time_zone_transition_type`
--
...
('localhost', 'root', '014a8fcc5eb33dcb', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('Teamstudy', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
...
('Teamstudy', '', '', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0);
--
-- 데이터베이스: `test`
--
